...
def test_openapi_contract_is_valid_json():
    ...
    expected = {
        ...
        "/api/v1/boletos/": {"get", "post"},
        "/api/v1/boletos/{boleto_id}/": {"get"},
        "/api/v1/boletos/{boleto_id}/status/": {"get"},
        "/api/v1/boletos/{boleto_id}/cancel/": {"post"},
        "/api/v1/boletos/{boleto_id}/resend/": {"post"},
        "/api/v1/boletos/{boleto_id}/second-copy/": {"post"},
